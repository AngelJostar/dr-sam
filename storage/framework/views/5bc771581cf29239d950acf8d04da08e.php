<section class="unit-service-carousel-card unit-catalog-carousel-card" data-unit-catalog-navigation data-unit-carousel-menu="<?php echo e($carouselMenu); ?>" data-unit-carousel-filter-kind="<?php echo e($carouselFilter); ?>">
  ...
  <div class="unit-service-carousel unit-catalog-carousel" data-unit-catalog-carousel role="group" aria-label="Filtros del menú">
    <?php $__currentLoopData = $catalogCarouselItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filterValue => [$catalogLabel, $catalogIcon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <button type="button"
              class="<?php echo \Illuminate\Support\Arr::toCssClasses(['unit-service-carousel-button', 'unit-catalog-carousel-button', 'is-active' => $filterValue === 'all']); ?>"
              data-unit-carousel-filter="<?php echo e($filterValue); ?>"
              aria-pressed="<?php echo e($filterValue === 'all' ? 'true' : 'false'); ?>">
        <span class="unit-service-carousel-icon" aria-hidden="true">
          <?php switch($catalogIcon):
            case ('catalog'): ?>
        ...
        <strong><?php echo e($catalogLabel); ?></strong>
      </button>
...
<?php /**PATH C:\laragon\www\dr-sam\resources\views/unit/_catalog_carousel.blade.php ENDPATH**/ ?>