  ...
  <div class="institution-native-screen">
    ...
    <aside class="institution-native-sidebar" aria-label="Navegacion institucional">
      <nav class="institution-native-menu">
        ...
        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['is-active' => $activeSection === 'doctors']); ?>" href="<?php echo e(route('institution.dashboard', ['institution' => $institution->id, 'section' => 'doctors'])); ?>">
    ...
    <section class="institution-native-workspace">
      ...
      <?php if($institutionCatalogUi): ?>
        <?php echo $__env->make('institution._catalog_workspace_header', ['institutionCatalogUi' => $institutionCatalogUi], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php elseif($activeSection !== 'services'): ?>
        <header class="institution-native-header">
          <div class="institution-native-title">
            ...
            <div><h1><?php echo e($activeSectionTitle); ?></h1></div>
          </div>
        </header>

        <?php if(in_array($activeSection, ['create-unit', 'edit-unit'], true)): ?>
          <nav class="institution-native-tabs" aria-label="Acciones de unidades">
            <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['is-active' => $activeSection === 'edit-unit']); ?>" href="<?php echo e(route('institution.dashboard', ['institution' => $institution->id])); ?>">Ver unidades</a>
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $institution->medicalUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr data-unit-row
                    ...
                    data-institution-catalog-status="<?php echo e($unit->status); ?>"
                    data-institution-catalog-groups="<?php echo e($unitCarouselGroups->implode(' ')); ?>"
                    data-institution-catalog-search="<?php echo e(str($unit->name.' '.$unit->clues.' '.$unit->code.' '.$unit->city.' '.$unit->municipality.' '.$unit->state.' '.$unit->type.' '.$unit->care_level)->lower()); ?>"
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pharmacyRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  ...
                  <tr data-pharmacy-row
                      ...
                      data-institution-catalog-status="<?php echo e($pharmacyStatus); ?>"
                      data-institution-catalog-search="<?php echo e(str($pharmacyName.' '.$pharmacyKey.' '.$unit->name.' '.$pharmacyResponsible.' '.$pharmacyLocation.' '.$pharmacySchedule)->lower()); ?>"
          ...
          <?php if($servicesCatalog->isNotEmpty()): ?>
            <section class="institution-service-carousel-card institution-catalog-carousel-card">
              ...
              <div class="institution-service-carousel institution-catalog-carousel" data-service-carousel aria-label="Servicios institucionales">
                <button type="button" class="institution-service-carousel-button"
                  ...
                  <strong>Todos</strong>
                  <small><?php echo e($servicesCatalog->count()); ?> <?php echo e($servicesCatalog->count() === 1 ? 'servicio' : 'servicios'); ?></small>
                </button>
                <?php $__currentLoopData = $servicesCatalog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <button type="button"
                          ...
                          data-service-carousel-button="<?php echo e($service->id); ?>" aria-pressed="<?php echo e($loop->first ? 'true' : 'false'); ?>">
            ...
            <div class="institution-service-panels">
              <article class="institution-service-panel institution-catalog-section-panel" data-service-panel="all" hidden>
                <header class="institution-service-panel-header">
                  <div class="institution-service-copy">
                    ...
                    <p>Catalogo institucional de <?php echo e($institution->name); ?></p>
                    <div><span class="institution-native-status"><?php echo e($servicesCatalog->count()); ?> <?php echo e($servicesCatalog->count() === 1 ? 'servicio' : 'servicios'); ?></span></div>
                  </div>
                </header>
                <?php echo $__env->make('institution._service_filter_toolbar', [
                  'filterScope' => 'all',
                ...
                <div class="institution-native-table-scroll">
                  <table class="institution-native-table institution-service-all-table">
                    ...
                    <tbody>
                      <?php $__currentLoopData = $servicesCatalog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $enabledUnits = $service->contractedServices->where('status', 'active')->count(); ?>
                        <tr data-institution-service-row
                            data-service-row-status="<?php echo e($service->status); ?>"
                            data-service-row-search="<?php echo e(str($service->name.' '.$service->specialty.' '.$service->category)->lower()); ?>">
                          <td><strong><?php echo e($service->name); ?></strong><small><?php echo e($service->specialty ?? 'Servicio general'); ?></small></td>
                          <td><?php echo e($service->category ?? 'Sin categoria'); ?></td>
                          <td><?php echo e($enabledUnits); ?> <?php echo e($enabledUnits === 1 ? 'hospital' : 'hospitales'); ?></td>
                          <td><span class="institution-native-status"><?php echo e($statusText($service->status)); ?></span></td>
                          <td><button type="button" data-service-select="<?php echo e($service->id); ?>">Ver detalle</button></td>
                        </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                  </table>
              ...
              <?php $__currentLoopData = $servicesCatalog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <article class="institution-service-panel institution-catalog-section-panel" data-service-panel="<?php echo e($service->id); ?>" <?php if(! $loop->first): ?> hidden <?php endif; ?>>
                  <header class="institution-service-panel-header">
                    <div class="institution-service-copy">
                    ...
                    <table class="institution-native-table institution-service-hospitals-table">
                      ...
                      <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          ...
                          ?>
                          <tr data-institution-service-row
                              data-service-row-status="<?php echo e($contract->status); ?>"
                              data-service-row-search="<?php echo e(str(($unit?->name ?? '').' '.($unit?->clues ?? $unit?->code ?? '').' '.$unitLocation.' '.$contract->contract_number)->lower()); ?>">
                            <td>
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $catalogItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  ...
                  <tr data-medication-row
                      ...
                      data-institution-catalog-status="<?php echo e($item->status); ?>"
                      data-institution-catalog-search="<?php echo e(str($item->name.' '.$item->cnis.' '.$itemGroup.' '.$itemPresentation.' '.$itemConcentration.' '.$itemRoute)->lower()); ?>">
                    <td>
                      <form method="post"
                            action="<?php echo e(route('institution.medications.status', $item)); ?>"
                            class="institution-medication-status-toggle"
                            data-institution-medication-toggle>
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('patch'); ?>
                        <input type="hidden" name="institution" value="<?php echo e($institution->id); ?>">
                        <input type="hidden" name="status" value="<?php echo e($item->status === 'active' ? 'inactive' : 'active'); ?>">
                        <button type="submit"
                                class="<?php echo \Illuminate\Support\Arr::toCssClasses(['institution-medication-status-switch', 'is-on' => $item->status === 'active']); ?>"
                                role="switch"
                                aria-checked="<?php echo e($item->status === 'active' ? 'true' : 'false'); ?>"
                                aria-label="<?php echo e($item->status === 'active' ? 'Desactivar' : 'Activar'); ?> <?php echo e($item->name); ?>"
                                title="<?php echo e($item->status === 'active' ? 'Desactivar' : 'Activar'); ?>">
                          <span aria-hidden="true"></span>
                        </button>
                      </form>
                    </td>
                    ...
                    <td><span class="<?php echo \Illuminate\Support\Arr::toCssClasses(['institution-native-status', 'is-inactive' => $item->status === 'inactive']); ?>"
                              data-institution-medication-status-label><?php echo e($statusText($item->status)); ?></span></td>
                    <td>
      ...
      <?php elseif($activeSection === 'doctors'): ?>
        <section class="institution-native-table-card institution-native-table-card-wide">
          <div class="institution-native-table-scroll">
            <table class="institution-native-table">
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $institutionDoctorRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctorRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php
                    $doctor = $doctorRow['doctor'];
                    $doctorUnit = $doctorRow['unit'];
                  ?>
                  <tr data-institution-catalog-row="doctors"
                      data-institution-catalog-status="<?php echo e($doctor->status); ?>"
                      data-institution-catalog-search="<?php echo e(str($doctor->full_name.' '.$doctor->professional_license.' '.$doctor->specialty.' '.$doctor->subspecialty.' '.$doctor->service_name.' '.$doctorUnit->name.' '.$doctorUnit->clues.' '.$doctorUnit->code)->lower()); ?>">
                    <td><strong><?php echo e($doctor->full_name); ?></strong><small><?php echo e($doctor->subspecialty ?? 'Atencion clinica'); ?></small></td>
                    <td><?php echo e($doctor->professional_license ?? 'Sin cedula'); ?></td>
                    <td><?php echo e($doctor->specialty ?? 'Sin especialidad'); ?></td>
                    <td><strong><?php echo e($doctorUnit->name); ?></strong><small><?php echo e($doctorUnit->clues ?? $doctorUnit->code ?? 'Sin clave'); ?></small></td>
                    <td><?php echo e($doctor->service_name ?? 'Sin servicio'); ?></td>
                    <td><span class="institution-native-status"><?php echo e($statusText($doctor->status)); ?></span></td>
                  </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $specialtyItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <tr data-specialty-row
                      ...
                      data-institution-catalog-status="<?php echo e($specialty->status); ?>"
                      data-institution-catalog-search="<?php echo e(str($specialty->name)->lower()); ?>"
                      data-name="<?php echo e(str($specialty->name)->lower()); ?>"
                      data-status="<?php echo e($specialty->status); ?>">
