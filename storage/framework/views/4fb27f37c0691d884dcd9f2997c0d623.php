...
<section class="institution-native-table-card institution-native-table-card-wide institution-subunit-catalog-card">
    ...
    <table class="institution-native-table institution-subunit-catalog-table">
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $subunitRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          ?>
          <tr data-subunit-row
              data-subunit-catalog-index="<?php echo e($row['number']); ?>"
              data-institution-catalog-row="subunits"
              data-institution-catalog-status="<?php echo e($row['status']); ?>"
              data-institution-catalog-search="<?php echo e(str($searchText)->lower()); ?>"
              data-subunit-unit="<?php echo e($row['parent_key']); ?>">
            <td class="institution-subunit-number"><?php echo e($row['number']); ?></td>
            <td><?php echo e($row['category']); ?></td>
            <td><strong><?php echo e($row['name']); ?></strong></td>
            <td><?php echo e($row['spaces']); ?></td>
            <td><?php echo e($row['equipment']); ?></td>
            <td>
              <?php echo e($row['parent'] ?? $pendingValue); ?>

              <?php if($row['parent_code']): ?>
                <span><?php echo e($row['parent_code']); ?></span>
              <?php endif; ?>
            </td>
            <td><?php echo e($row['code'] ?? $pendingValue); ?></td>
            <td><?php echo e($row['location'] ?? $pendingValue); ?></td>
            <td><?php echo e($row['responsible'] ?? $pendingValue); ?></td>
            <td><?php echo e($row['spaces_registered'] ?? $pendingValue); ?></td>
            <td><?php echo e($row['equipment_assigned'] ?? $pendingValue); ?></td>
            <td><?php echo e($row['services'] ?? $pendingValue); ?></td>
            <td>
              <?php if($row['status'] === 'pending'): ?>
                <span class="institution-subunit-pending" aria-label="Pendiente de captura"><?php echo e($pendingValue); ?></span>
              <?php else: ?>
            ...
            <td class="institution-subunit-action-cell">
              <div class="institution-native-actions institution-subunit-control-actions">
                <button type="button" data-subunit-action="view" title="Ver detalle de <?php echo e($row['name']); ?>">
            ...
            <td class="institution-subunit-action-cell">
              <div class="institution-native-actions institution-subunit-control-actions">
                <button type="button" data-subunit-action="edit" title="Editar <?php echo e($row['name']); ?>">
            ...
            <td class="institution-subunit-action-cell">
              <div class="institution-native-actions institution-subunit-control-actions">
                <button type="button" data-subunit-action="spaces" title="Administrar espacios de <?php echo e($row['name']); ?>">
            ...
            <td class="institution-subunit-action-cell">
              <div class="institution-native-actions institution-subunit-control-actions">
                <button type="button" data-subunit-action="equipment" title="Asignar equipamiento a <?php echo e($row['name']); ?>">
  ...
  <footer class="institution-native-table-footer institution-native-table-footer-all-results">
    <span data-subunit-footer-summary>Mostrando <?php echo e(number_format($subunitCount)); ?> de <?php echo e(number_format($subunitCount)); ?> subunidades</span>
  </footer>
</section>
