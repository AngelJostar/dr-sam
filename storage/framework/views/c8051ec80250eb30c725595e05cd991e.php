...
<?php $__env->startSection('content'); ?>
  <div class="unit-native-screen">
    ...
    <section class="unit-native-workspace">
      ...
      <?php if(! in_array($section, ['services', 'procedure-areas'], true)): ?>
      ...
      <?php elseif($section === 'services'): ?>
        ...
        <div class="unit-service-dashboard" data-unit-service-dashboard>
          <?php if($unitServiceContracts->isNotEmpty()): ?>
            ...
            <?php if($consultationContract): ?>
              <section class="unit-consultation-submenu-card" data-unit-consultation-submenu <?php if(! $activeServiceIsConsultation): ?> hidden <?php endif; ?>>
              ...
              <?php $__currentLoopData = $unitServiceContracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <section class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                  ...
                  <header class="unit-service-panel-header">
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['unit-consultation-calendar-title' => $isConsultationService]); ?>">
                      ...
                      <div>
                        ...
                        <p><?php echo e($isConsultationService ? 'Agenda de consultas' : (($service?->category ?? 'Sin categoria').' · '.($service?->specialty ?? 'Servicio general'))); ?></p>
                          ...
                          <form method="post" action="<?php echo e(route('unit.appointments.store')); ?>" class="unit-consultation-flow-shell" data-unit-calendar-new-form>
                            ...
                            <section class="unit-consultation-wizard-step" data-unit-new-step="1">
                              ...
                              <div class="unit-consultation-form-grid">
                                ...
                                <label><span>Fecha <b>*</b></span><input type="date" name="appointment_date" data-unit-new-field="appointment_date" min="<?php echo e(now()->toDateString()); ?>" value="<?php echo e(now()->toDateString()); ?>" required></label>
                                <label class="is-wide">
                          ...
                          <table class="unit-native-table unit-nutrition-request-table">
                            ...
                            <tbody>
                              <?php $__empty_1 = true; $__currentLoopData = $serviceProviderRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nutritionRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                ?>
                                <tr data-unit-nutrition-row data-category="<?php echo e($nutritionCategory); ?>">
                    ...
                    <?php else: ?>
                      <div class="unit-native-table-scroll">
                        <table class="unit-native-table unit-service-detail-table">
                          ...
                          <tbody>
                            <tr>
                              <td><strong><?php echo e($unit->name); ?></strong><small><?php echo e($unit->type ?? $unit->typology ?? 'Hospital General'); ?></small></td>
                              <td><?php echo e($unit->clues ?? $unit->code ?? 'Sin CLUES'); ?></td>
                              <td><?php echo e($unitLocation); ?></td>
        ...
        <section class="unit-service-carousel-card unit-procedure-carousel-card">
          ...
          <div class="unit-service-carousel unit-procedure-carousel" data-procedure-carousel aria-label="Categorias de areas de procedimiento">
            <?php $__currentLoopData = $procedureCatalogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalogKey => $catalog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <button type="button"
                      class="<?php echo \Illuminate\Support\Arr::toCssClasses(['unit-service-carousel-button', 'unit-procedure-carousel-button', 'is-active' => $catalogKey === $activeProcedureCatalog]); ?>"
                      data-procedure-category="<?php echo e($catalogKey); ?>">
                <span class="unit-service-carousel-icon" aria-hidden="true">
                  <?php switch($catalogKey):
                    case ('consulting'): ?>
                      <svg viewBox="0 0 24 24"><path d="M6 4v5a4 4 0 0 0 8 0V4"/><path d="M10 13v2a5 5 0 0 0 10 0v-2"/><circle cx="20" cy="10" r="2"/><path d="M4 4h4M12 4h4"/></svg>
                      <?php break; ?>
                    <?php case ('infusion'): ?>
                ...
                <strong><?php echo e($catalog['button']); ?></strong>
              </button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        ...
        <div class="unit-procedure-catalogs">
          <?php $__currentLoopData = $procedureCatalogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalogKey => $catalog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <section class="unit-native-table-card unit-procedure-card" data-procedure-catalog="<?php echo e($catalogKey); ?>" <?php if($catalogKey !== $activeProcedureCatalog): ?> hidden <?php endif; ?>>
              <div class="unit-native-table-heading unit-native-heading-action">
                <div><h2><?php echo e($catalog['title']); ?></h2><p><?php echo e($catalogAreas->count()); ?> subunidades</p></div>
                <div class="unit-procedure-heading-actions"><button type="button" data-procedure-export>Descargar catalogo</button><a class="is-primary" href="<?php echo e(route('unit.dashboard', ['section' => 'procedure-areas', 'create' => $catalogKey])); ?>"><?php echo e($catalog['create']); ?></a></div>
              </div>
              <div class="unit-native-table-scroll">
              ...
              <?php if(request('create') === $catalogKey || $editingArea): ?>
                <form method="post" action="<?php echo e($editingArea ? route('unit.procedure-areas.update', $editingArea['id']) : route('unit.procedure-areas.store')); ?>" class="unit-procedure-form">
                  ...
                  <header><strong><?php echo e($editingArea ? 'Editar '.$catalog['singular'] : 'Nueva subunidad'); ?></strong><span><?php echo e(ucfirst($catalog['singular'])); ?></span></header>
                  ...
                  <div class="unit-procedure-form-actions wide"><button type="submit"><?php echo e($editingArea ? 'Guardar cambios' : 'Guardar subunidad'); ?></button><a href="<?php echo e(route('unit.dashboard', ['section' => 'procedure-areas', 'catalog' => $catalogKey])); ?>">Regresar</a></div>
                </form>
              <?php endif; ?>
            </section>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <section class="unit-native-table-card">
          <div class="unit-native-table-heading unit-native-heading-action">
            <div>
              ...
              <p><span data-medication-visible><?php echo e($medicationCatalog->count()); ?></span> visibles de <?php echo e($medicationCatalog->count()); ?> medicamentos - <?php echo e($medicationCatalog->where('status', 'active')->count()); ?> activos</p>
            </div>
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $medicationCatalog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <tr data-medication-row>
                    ...
                    <td><strong><?php echo e($item->name); ?></strong><small><?php echo e($item->description ?? 'Sin descripcion'); ?></small></td>
                    <td><?php echo e($item->generic_name ?? $item->name); ?></td>
                    <td><?php echo e($item->therapeutic_group ?? data_get($item->metadata, 'group', 'Sin grupo')); ?></td>
                    <td><?php echo e($item->presentation ?? 'Sin presentacion'); ?></td>
                    <td>
                      <?php if($item->controlled): ?><span class="unit-native-status is-warning">Controlado</span><?php endif; ?>
                      <?php if($item->requires_prescription): ?><small>Requiere receta</small><?php elseif(! $item->controlled): ?><small>Venta libre</small><?php endif; ?>
                      <?php if($item->cold_chain): ?><small>Cadena fria</small><?php endif; ?>
                    </td>
                    <td><span class="<?php echo \Illuminate\Support\Arr::toCssClasses(['unit-native-status', 'is-warning' => $item->status === 'inactive']); ?>"><?php echo e($statusText($item->status)); ?></span></td>
                  </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
